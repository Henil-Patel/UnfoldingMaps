...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {	
		...
		fill(color(255, 0, 0));
		ellipse(50, 200, radius, radius);
		fill(color(0, 255, 0));
		ellipse(50, 225, radius, radius);
		fill(color(0, 0, 255));
		ellipse(50, 250, radius, radius);
		fill(color(255, 255, 255));
		ellipse(50, 125, radius, radius);
		fill(color(255, 255, 255));
		rect(45, 145, 10, 10);
		fill(color(255, 255, 255));
		ellipse(50, 275, 12.5f, 12.5f);
		line(45, 270, 55, 280);
		line(55, 270, 45, 280);
	...
	private void printQuakes() 
	{
		...
		for (Marker cm: countryMarkers) {
			...
			int landQuakesPerCountry = 0;
			for (Marker mk: quakeMarkers) {
				EarthquakeMarker em = (EarthquakeMarker)mk;
				if (em.isOnLand()) {
					if (countryName.equals((String)em.getProperty("country"))) {
						landQuakesPerCountry++;
					}
				}
			}
			if (landQuakesPerCountry > 0) {
				totalQuakes -= landQuakesPerCountry;
				System.out.println("Country: " + countryName + ", EarthQuakes: " + landQuakesPerCountry);
			}
